 ...
 *
 */
public class IomReqApplicationDomain {
    ...
    private Map platDamagesFee;

    private Map investorDamagesFee;
    ...
    public String getMaxPutoutDays() {
        return maxPutoutDays;
    }

    public void setMaxPutoutDays(String maxPutoutDays) {
    ...
    public Map getPlatDamagesFee() {
        return platDamagesFee;
    }

    public void setPlatDamagesFee(Map platDamagesFee) {
        this.platDamagesFee = platDamagesFee;
    }

    public Map getInvestorDamagesFee() {
        return investorDamagesFee;
    }

    public void setInvestorDamagesFee(Map investorDamagesFee) {
    ...
    public Map getOtherFeesList() { return otherFeesList; }

    public void setOtherFeesList(Map otherFeesList) { this.otherFeesList = otherFeesList; }
