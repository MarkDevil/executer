...
public class FtpUtils {
    ...
    public static void main(String[] args) {
        FtpUtils ftpClient = new FtpUtils("localhost",21,"mark","1");
        ftpClient.open();
//        ftpClient.mkDir("marktest");
        ftpClient.upload("/Users/mark/gitworkspace/toolbox/src/main/resources/logback.xml","log.xml","/marktest");
        ftpClient.close();
